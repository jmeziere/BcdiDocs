...
makedocs(
    ...
    remotes = Dict(
        "./"=>Documenter.Remotes.GitHub("byu-cxi", "BcdiCore.jl.git"),
        "./"=>Documenter.Remotes.GitHub("byu-cxi", "BcdiTrad.jl.git"),
        "./"=>Documenter.Remotes.GitHub("byu-cxi", "BcdiStrain.jl.git"),
        "./"=>Documenter.Remotes.GitHub("byu-cxi", "BcdiMeso.jl.git")
    )
)
